% This the UEA_archive_wws--1/pgfplot_f1-score_wws=1.0.tex file.
% It was created by the python TexPlots class at 2021-10-16 13:33:42

\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{%
		1439.6096718749998, 0.5693673391516
	}\bagdtw
	\pgfplotstableread[col sep=comma]{%
		630.9105363206436, 0.5174843267572641
	}\dagdtw
	\pgfplotstableread[col sep=comma]{%
		3.6171254253563387, 0.32948766962273934
	}\ddtw
	\pgfplotstableread[col sep=comma]{%
		2.646025651572736, 0.5614740774112894
	}\dtw
	\pgfplotstableread[col sep=comma]{%
		435.241186404286, 0.5487921234004711
	}\sdtw
	\pgfplotstableread[col sep=comma]{%
		5.6331736577869025, 0.32948766962273934
	}\wddtw
	\pgfplotstableread[col sep=comma]{%
		4.9272285214300995, 0.5614740774112894
	}\wdtw
	\begin{axis}[
		table/col sep = comma,
		xmode = log,
