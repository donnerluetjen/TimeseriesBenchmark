% This the UCR_archive_wws-0-3/pgfplot_auroc_wws=0.3.tex file.
% It was created by the python TexPlots class at 2021-10-16 13:33:42

\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{%
		2468.8741657080377, 0.8681905608067422
	}\bagdtw
	\pgfplotstableread[col sep=comma]{%
		1003.0080779074148, 0.8002727978755397
	}\dagdtw
	\pgfplotstableread[col sep=comma]{%
		14.08900703175695, 0.5
	}\ddtw
	\pgfplotstableread[col sep=comma]{%
		9.521457535698, 0.8352496799278711
	}\dtw
	\pgfplotstableread[col sep=comma]{%
		5771.863366587321, 0.858662912884253
	}\sdtw
	\pgfplotstableread[col sep=comma]{%
		15.893628962262813, 0.5
	}\wddtw
	\pgfplotstableread[col sep=comma]{%
		11.469114030528306, 0.8352496799278711
	}\wdtw
	\begin{axis}[
		table/col sep = comma,
		xmode = log,
