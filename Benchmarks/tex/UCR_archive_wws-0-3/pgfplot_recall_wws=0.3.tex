% This the UCR_archive_wws-0-3/pgfplot_recall_wws=0.3.tex file.
% It was created by the python TexPlots class at 2021-10-16 13:33:42

\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{%
		2468.8741657080377, 0.8213632212403776
	}\bagdtw
	\pgfplotstableread[col sep=comma]{%
		1003.0080779074148, 0.7317736175730492
	}\dagdtw
	\pgfplotstableread[col sep=comma]{%
		14.08900703175695, 0.3340745732255166
	}\ddtw
	\pgfplotstableread[col sep=comma]{%
		9.521457535698, 0.7786929686970417
	}\dtw
	\pgfplotstableread[col sep=comma]{%
		5771.863366587321, 0.8150279260216815
	}\sdtw
	\pgfplotstableread[col sep=comma]{%
		15.893628962262813, 0.3340745732255166
	}\wddtw
	\pgfplotstableread[col sep=comma]{%
		11.469114030528306, 0.7786929686970417
	}\wdtw
	\begin{axis}[
		table/col sep = comma,
		xmode = log,
