% This the UEA_archive_wws-0-3/pgfplot_ranking_wws=0.3.tex file.
% It was created by the python TexPlots class at 2021-10-16 13:33:42

\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{%
		872.8022465117148, 1.2281574684734426
	}\bagdtw
	\pgfplotstableread[col sep=comma]{%
		320.42796049614236, 1.1854681004703405
	}\dagdtw
	\pgfplotstableread[col sep=comma]{%
		2.2223828057139343, 0.8286197966560466
	}\ddtw
	\pgfplotstableread[col sep=comma]{%
		1.8199050099285918, 1.2238125541414564
	}\dtw
	\pgfplotstableread[col sep=comma]{%
		391.6559988592863, 1.2124378736754249
	}\sdtw
	\pgfplotstableread[col sep=comma]{%
		3.9864909813572678, 0.8286197966560466
	}\wddtw
	\pgfplotstableread[col sep=comma]{%
		3.58506056092912, 1.2238125541414564
	}\wdtw
	\begin{axis}[
		table/col sep = comma,
		xmode = log,
		...
		\addplot+ [every node/.append style={xshift=-2pt}]  table[ x index = {0}, y index = {1}]{\sdtw};
