% This the UEA_archive_wws-0-3/pgfplot_recall_wws=0.3.tex file.
% It was created by the python TexPlots class at 2021-10-16 13:33:42

\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{%
		872.8022465117148, 0.5916000511231861
	}\bagdtw
	\pgfplotstableread[col sep=comma]{%
		320.42796049614236, 0.563525605717512
	}\dagdtw
	\pgfplotstableread[col sep=comma]{%
		2.2223828057139343, 0.3589732767269766
	}\ddtw
	\pgfplotstableread[col sep=comma]{%
		1.8199050099285918, 0.588349200378416
	}\dtw
	\pgfplotstableread[col sep=comma]{%
		391.6559988592863, 0.5793222181979611
	}\sdtw
	\pgfplotstableread[col sep=comma]{%
		3.9864909813572678, 0.3589732767269766
	}\wddtw
	\pgfplotstableread[col sep=comma]{%
		3.58506056092912, 0.588349200378416
	}\wdtw
	\begin{axis}[
		table/col sep = comma,
		xmode = log,
