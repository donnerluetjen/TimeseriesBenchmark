% This the UCR_archive_wws--1/pgfplot_ranking_wws=1.0.tex file.
% It was created by the python TexPlots class at 2021-10-16 13:33:42

\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{%
		3764.188713644189, 1.6550972179485264
	}\bagdtw
	\pgfplotstableread[col sep=comma]{%
		1914.245479715869, 1.4761684626019969
	}\dagdtw
	\pgfplotstableread[col sep=comma]{%
		17.39747724943514, 0.7573917431890258
	}\ddtw
	\pgfplotstableread[col sep=comma]{%
		13.045470390868147, 1.6080729734355386
	}\dtw
	\pgfplotstableread[col sep=comma]{%
		6076.276831380926, 1.6444235312163344
	}\sdtw
	\pgfplotstableread[col sep=comma]{%
		18.933300181981483, 0.7573917431890258
	}\wddtw
	\pgfplotstableread[col sep=comma]{%
		14.06638409298067, 1.6080729734355386
	}\wdtw
	\begin{axis}[
		table/col sep = comma,
		xmode = log,
