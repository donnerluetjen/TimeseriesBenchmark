% This the UCR_archive_wws--1/pgfplot_auroc_wws=1.0.tex file.
% It was created by the python TexPlots class at 2021-10-16 13:33:42

\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{%
		3764.188713644189, 0.8650526576040631
	}\bagdtw
	\pgfplotstableread[col sep=comma]{%
		1914.245479715869, 0.79447909820688
	}\dagdtw
	\pgfplotstableread[col sep=comma]{%
		17.39747724943514, 0.5
	}\ddtw
	\pgfplotstableread[col sep=comma]{%
		13.045470390868147, 0.845114126764957
	}\dtw
	\pgfplotstableread[col sep=comma]{%
		6076.276831380926, 0.8574988355881263
	}\sdtw
	\pgfplotstableread[col sep=comma]{%
		18.933300181981483, 0.5
	}\wddtw
	\pgfplotstableread[col sep=comma]{%
		14.06638409298067, 0.845114126764957
	}\wdtw
	\begin{axis}[
		table/col sep = comma,
		xmode = log,
